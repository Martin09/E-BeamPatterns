...
# TODO: Add neighbouring membranes to the branches with pitch of 1um
...
WAFER_ID = '000045672834'  # CHANGE THIS FOR EACH DIFFERENT WAFER
PATTERN = 'SQBR1.1'
...
class MBE100Wafer(Wafer_GridStyle):
    ...
    def add_cleave_xsection_nws(self):
        ...
        for block in self.blocks:
            ...
            block.add(cleave_xsection_cell, origin=(center_x - 300, center_y + 500), rotation=45.)
