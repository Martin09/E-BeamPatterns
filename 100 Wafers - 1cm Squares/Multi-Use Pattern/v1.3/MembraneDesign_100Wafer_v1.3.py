...
wafer_r = 25e3
waferVer = '100 Membranes Multi-Use v1.3'.format(int(wafer_r / 1000))
...
class Frame(Cell):
    ...
    def make_slit_array(self, _pitches, spacing, _widths, _lengths, rot_angle,
        ...
        self.add(manyslits,
                 origin=(-i * (array_width + array_spacing) / 2 + hacky_offset_x,
...
smField4.make_slit_array(pitches[1], slitColumnSpacing, widths, length, 45, 100, 100, 30, l_smBeam)
