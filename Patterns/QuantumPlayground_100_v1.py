...
def makeShape_Square(pitch, length, width, contactlength, n_outer_buf, layer):
    ...
    line_cell.add(line)
    square_arm.add(line_cell, origin=(0, 0))

    n_inner_buf = int(length / 2. / pitch) + 1
    ...
    for i in range(1, n_inner_buf):
        ...
        line_cell.add(line)
        square_arm.add(line_cell, origin=(0, -i * pitch))
...
def make_qp():
    ...
    for i, nm_width in enumerate(widths):
        ...
        cell_Triangle = makeShape_Square(1.0, 5, nm_width, 1.0, 3, l_smBeam)
        cell_TriangleNoBuffer = makeShape_Square(10.0, 5, nm_width, 1.0, 0, l_smBeam)
        ...
        cell_Triangle_sm = makeShape_Square(1.0, 1, nm_width, 1.0, 5, l_smBeam)
        cell_TriangleNoBuffer_sm = makeShape_Square(10.0, 1, nm_width, 1.0, 0, l_smBeam)
