...
Changes:
- updated to only have 3 membrane widths, as requested by Kris from Basel
-
"""
...
WAFER_ID = 'XXXXXX'  # CHANGE THIS FOR EACH DIFFERENT WAFER
PATTERN = 'BM4.8'
CELL_GAP = 3000
...
wafer_r = 25e3
waferVer = 'Membranes Wafer v4.42 r{:d}'.format(int(wafer_r / 1000))
