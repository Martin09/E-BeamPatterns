...
from gdsCAD_v045.templates111 import dashed_line
from GrowthTheoryCell_BranchDevices import make_rotating_branch_devices
...
def make_theory_cell_br():
    ...
    for i in range(N_rows):
        ...
        if i == 0:
            angle_ref = True
        wheel1.add(make_rotating_branches(shape_len, shape_wid, _N, wheel_rad + i * shape_len, l_smBeam,
    ...
    for i in range(N_rows):
        ...
        if i == 0:
            angle_ref = True
        wheel3.add(make_rotating_branch_devices(shape_len, shape_wid, _N, wheel_rad + i * shape_len * 2., l_smBeam,
                                                angle_sweep=_angle_sweep,
                                                angle_ref=angle_ref,
                                                angle_offset=angle_offset))
