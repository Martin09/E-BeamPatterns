...
wafer_r = 25e3
waferVer = '111A NWs Wafer v1.0 r{:d}'.format(int(wafer_r / 1000))
waferLabel = waferVer
...
class MBEWafer(Wafer_TriangStyle):
    ...
    def add_tem_nanowires(self):
        ...
        shapes_small = make_shape_array(size, 0.005, 0.75, 'hexagons', l_smBeam, labels=False)
